...
function Footer() {
  ...
  const overlayStyle = {
    ...
    width: '100%',
    height: '100%',
    background: 'rgba(0, 0, 0, 0.8)', // تعديل قيمة الشفافية المطلوبة هنا
    pointerEvents: 'none', // السماح بتمرير النقرات عبر الطبقة العلوية
  };

  return (
    <>
    <div className="relative">
      <div style={overlayStyle}></div> {/* الطبقة العلوية للصورة الخلفية */}
    ...
    <h1 className="font-semibold text-white">
      © 2023 جميع الحقوق محفوظة | تم بناء الموقع بواسطة{" "}
